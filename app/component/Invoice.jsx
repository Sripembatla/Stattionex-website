...
const Invoice = ({ invoiceId }) => {
  ...
  const generateInvoicePDF = (data) => {
    // Destructure the invoiceData to get customer and items
  ...
  <!-- Site Title -->
  <title>Fashion Mate Invoice</title>
  ...
  <body>
  <div class="tm_container" style="width:210mm; height:256mm" >
    <div class="tm_invoice_wrap">
        <div class="tm_invoice tm_style1 tm_type3" style=""  id="tm_download_section">
            ...
            <div class="tm_invoice_in">
                <table>
                    <tbody>
                        <tr>
                            ...
                            src="https://new.d1sxehwz73fgxh.amplifyapp.com/assets/icons/logo_golden.svg"
                            alt="Logo">
                    </div>
                            </td>
                            <td style="margin-top: 50px; margin-left: 20px;" class="tm_invoice_right tm_text_right">
                                <p class="tm_blue tm_semi_bold  tm_text_uppercase" style="font-size:26px"> Invoice</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table style="margin-top: 20px">
                    <tr>
                    <th style="border-radius: 20px 0 0 20px;" class="">
                            <span class="tm_m0 tm_semi_bold">Order Date: ${
                              data.createdAt
                            }</span><br>
                            <span class="tm_m0 tm_semi_bold">Order No: ${
                              data?.orderId?._id || "NA"
                            }</span>
                        </th>
                        
                        <th style="border-radius: 20px 0 0 20px; text-align: right;" class="">
                            <span class="tm_m0 tm_semi_bold">Invoice Date: ${
                              data.createdAt
                            }</span><br>
                            <span class="tm_m0 tm_semi_bold">Invoice No: ${
                              data.invoiceNumber
                            }</span>
                        </th>
                    </tr>
                ...
                <table class="">
                    <tr>
                        ...
                        <p class="tm_mb2"><b class="tm_primary_color">Sold By:</b></p>
                            <p class="tm_m0 ">
                            ${data.items[0].soldBy.username}</br>
                                5678 Business Ave, Los Angeles, CA</br>
                                PAN: ABCDE1234F </br>
                                GSTIN: XYZ1234GST</p>
                            
                        </td>
                        <td class="tm_invoice_center" style="width:20%"></td>
                        <td class="tm_invoice_right tm_text_right" style="width:30%;vertical-align:top">
    ...
    <thead>
      <tr>
        <th class="tm_width_1 tm_semi_bold tm_white_color tm_blue_bg" style="border-radius: 20px 0 0 20px">Sr.No</th>
        <th class="tm_width_4 tm_semi_bold tm_white_color tm_blue_bg">Description</th>
        <th class="tm_width_2 tm_semi_bold tm_white_color tm_blue_bg">Unit price</th>
        <th class="tm_width_1 tm_semi_bold tm_white_color tm_blue_bg">Qty</th>
        <th class="tm_width_2 tm_semi_bold tm_white_color tm_blue_bg">Price</th>
        <th class="tm_width_1 tm_semi_bold tm_white_color tm_blue_bg">Disc.</th>
        <th class="tm_width_2 tm_semi_bold tm_white_color tm_blue_bg">Taxes</th>
        <th class="tm_width_2 tm_semi_bold tm_white_color tm_blue_bg" style="border-radius: 0 20px 20px 0">Amount</th>
      </tr>
    </thead>
    <tbody>
      ${data.items.map((item, index) => {
        return `
          <tr>
            ...
            <td class="tm_width_4">${item.productId.name}</td>
            <td class="tm_width_2" style="text-transform: capitalize;">${item.price}</td>
            <td class="tm_width_1">${item.quantity}</td>
            <td class="tm_width_2">${item.price}</td>
            <td class="tm_width_1">0</td>
            <td class="tm_width_2">
              ${item.productId.totalGstPercent > 0 
                ? `₹${((item.price * item.productId.totalGstPercent) / 100).toFixed(2)}`
                : 0}
            </td>
            <td class="tm_width_2">
              ${(
                item.price + (item.price * item.productId.totalGstPercent) / 100
              ).toFixed(2)}
            </td>
          </tr>
        `;
                ...
                <div class="tm_invoice_footer">
                  ...
                  <div class="tm_right_footer">
                     <table>
                                <tbody>
                                    <tr>
                                        <td class="tm_width_4 tm_primary_color tm_border_none tm_semi_bold">Delhivery Charges</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_semi_bold">
                                            ₹${data.deliveryCharge || 0}</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_4 tm_primary_color tm_border_none tm_semi_bold">Gross
                                            Amount</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_semi_bold">
                                            ₹${data.totalAmount}</td>
                                    </tr>
                                    ...
                                    <tr class="tm_border_top tm_border_bottom">
                                        <td class="tm_width_4 tm_border_top_0 tm_semi_bold tm_f16 tm_primary_color">
                                            Total Tax </td>
                                        <td class="tm_width_4 tm_border_top_0 tm_semi_bold tm_f16 tm_primary_color tm_text_right">
                                            ₹${data.gstAmount}</td>
                                    </tr>
                                    <tr class="tm_border_top tm_border_bottom">
                                        <td class="tm_width_4 tm_border_top_0 tm_semi_bold tm_f16 tm_primary_color">
                ...
                <table style="margin-bottom: 130px; margin-top: -25px;">
                    <tbody>
                        <tr>
                            <td class="tm_width_4 tm_primary_color tm_border_none tm_semi_bold" style="color:#fff">
                                Payment Communication: INV / 2024 / 00001
                            </td>
                            <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_semi_bold">Total
                                amount in words: ${toWords(data.totalAmount)}
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0" style="vertical-align:top"><p>
  ...
  const fetchInvoiceData = async (invoiceId) => {
    try {
      ...
      const AUTHORIZATION_KEY = process.env.NEXT_PUBLIC_AUTHORISED_KEY;
      const fmauserToken = Cookies.get("fmauser");

      const response = await fetch(
        `${API_URL}/v1/customer/invoice/get?invoiceId=${invoiceId}`,
        {
          method: "GET",
          headers: {
            authorisedKey: AUTHORIZATION_KEY,
            accessToken: fmauserToken,
      ...
      // Call the function to generate the PDF after the data is fetched
  ...
  //     // Dummy data for testing the invoice
  //     const dummyData = {
  //       invoiceId: '12345',
  //       customer: {
  //         name: 'John Doe',
  ...
  //     // Simulate successful response and generate PDF
  //     setTimeout(() => {
  //       generateInvoicePDF(dummyData); // Use the dummy data to generate the invoice PDF
  //       setLoading(false); // Reset loading state after generating the PDF
  //     }, 1000); // Simulate a 1 second delay (like an API call)
  //   };

  return (
    <button
      onClick={() => fetchInvoiceData(invoiceId)}
      disabled={loading}
      style={{
        padding: "10px 20px",
        fontSize: "15px",
    ...
    >
      ...
      <span style={{ fontSize: "20px" }}>
        {loading ? "Generating Invoice..." : "Invoice"}
      </span>
    </button>
  );
};
